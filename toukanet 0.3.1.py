...
#collision platform and sprite
        ...
        if self.x <= 512 and self.x >= 384 and self.y <= 15 * TILE and self.y >= 102:
            self.y = 102
        if self.x >= 23 * TILE and self.x <= 39 * TILE and self.y <= 15* TILE and self.y >= 102:
            self.y = 102
        ...
        if self.x <= 512 and self.x >= 384 and self.y <= 31 * TILE and self.y >= 230:
            self.y = 230
        if self.x >= 23 * TILE and self.x <= 39 * TILE and self.y <= 31 * TILE and self.y >= 230:
            self.y = 230
#platform y = -136        
        self.flying = False
        if self.y < 367 :
...
class App:
    ...
    def fruit_collision(self):
        ...
        for fruit in self.fruits_list:
            if fruit[0] <= self.player.x + 16 and fruit[1] <= self.player.y + 16 and enemy[0] + 16 >= self.player.x and fruit[1] + 16 >= self.player.y:
                self.fruits_list.remove(fruit)
